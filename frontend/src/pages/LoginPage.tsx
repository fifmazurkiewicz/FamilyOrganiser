...
const features = [
  { icon: Users, label: "Wspólne budżety rodzinne" },
  { icon: TrendingUp, label: "Śledzenie oszczędności i inwestycji" },
  { icon: Shield, label: "Bezpieczne dane szyfrowane" },
];
        ...
        <div className="relative z-10 space-y-8">
          <div>
            <h2 className="text-3xl font-bold leading-tight">
              Zarządzaj finansami<br />całej rodziny
            </h2>
            <p className="mt-3 text-emerald-100 text-lg">
              Wszystko w jednym miejscu — budżet, oszczędności, inwestycje
            </p>
          </div>
