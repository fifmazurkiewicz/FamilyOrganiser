...
- Global custom subagents live under `C:\Users\MSI\.cursor\agents\` for reuse across projects; prefer them for specialized roles rather than duplicating long role prompts in every chat.
